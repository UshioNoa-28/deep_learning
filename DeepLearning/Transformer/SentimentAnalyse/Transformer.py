...
from DeepLearning.Transformer.SentimentAnalyse.model import Transformer
...
state_nums=3
max_seq_len = 120
net=Transformer(embedding_dim,2,2,hidden_layer1,hidden_layer2,vocab_size,max_seq_len,2,2,state_nums)
net=net.to("cuda")
# region 下面为数据处理部分
